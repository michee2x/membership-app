...
<div style={{backgroundImage:"url(https://i.imgur.com/uu0Qg9x.jpeg)", backgroundPosition:'bottom', backgroundSize:'cover'}} className="text-center mt-12 mb-8 relative w-full mx-auto h-[20rem] rounded-lg md:p-8 dark:bg-gray-800" id="about" role="tabpanel" aria-labelledby="about-tab">
