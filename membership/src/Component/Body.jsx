...
<div className='w-full relative h-full '>
      <h2 data-aos="fade-up" className="mb-3 text-xl mx-auto bg-gradient-to-tl from-blue-500 via-blue-200 to-white text-transparent bg-clip-text max-w-md md:text-2xl font-extrabold tracking-normal pt-7 text-gray-700">Welcome to Alex Terrible's VIP fan membership Card Signup</h2>
