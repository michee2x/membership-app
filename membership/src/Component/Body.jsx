...
<div className='w-full relative h-full '>
      <h2 data-aos="fade-up" className="mb-3 text-lg mx-auto bg-gradient-to-t from-blue-500 via-blue-200 to-white text-transparent bg-clip-text max-w-md md:text-2xl font-extrabold tracking-normal pt-5 text-gray-700">Alex Terrible's VIP fan membership Card Signup</h2>
