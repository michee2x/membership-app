...
app.use(cors({credentials:true, origin:["https://slaughter-to-prevail.onrender.com", "https://membership-fm1j08zs4-michael-xarvyns-projects.vercel.app"], methods:["POST", "GET"]}))
